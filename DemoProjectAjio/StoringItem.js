...
export default function StoringItem(props) {
  return (
    <SafeAreaView style={{backgroundColor:'white',flex:1}}>
      ...
      />
      <View style={{height:80,backgroundColor:'#14253f',alignItems:'center',justifyContent:'center',marginTop:2}}>
        <Text style={{fontSize:25,letterSpacing:2,fontFamily:'Georgia-BoldItalic',color:'white'}}>
          AJIO CARES
        </Text>
      </View>
      </ScrollView>
