...
const data = [
  ...
  {
    image: require('../src/assests/Images/kid3.jpeg'),
  },
  {
    image: require('../src/assests/Images/kid4.jpeg'),
  },
  {
    image: require('../src/assests/Images/kid5.jpeg'),
  },
  {
    image: require('../src/assests/Images/kid6.jpeg'),
  },
];
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.upperview}>
        ...
        <Text style={styles.text}>Kid's</Text>
      </View>
      <FlatList
        numColumns={2}
        data={data}
