...
function App(){
    ...
    return(
       ...
       //   options={{ headerTitle: (props) => <LogoTitle {...props} /> }}
           ...
           options={{headerBackTitle:'peeche',headerBackTitleStyle: {
            color: 'blue'
        }}}
